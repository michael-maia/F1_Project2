...
namespace F1_Project.Controllers
{
    public class CircuitsController : Controller
    {
        ...
        public CircuitsController(DBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,NumberRacesHeld,CircuitLength,NumberLaps,YearFirstRace,LapRecord,Description,Photo")] Circuit circuit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,NumberRacesHeld,CircuitLength,NumberLaps,YearFirstRace,LapRecord,Description,Photo")] Circuit circuit)
        {
            if (id != circuit.Id)
            {
                return NotFound();
